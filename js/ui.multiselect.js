...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		// set dimensions
		this.container.width(this.element.width()+201);
		this.selectedContainer.width(Math.floor(this.element.width()*this.options.dividerLocation)+100);
		this.availableContainer.width(Math.floor(this.element.width()*(1-this.options.dividerLocation))+100);

		// fix list height to match <option> depending on their individual header's heights
		this.selectedList.height(170);
		this.availableList.height(170);

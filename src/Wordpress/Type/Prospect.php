...
namespace Teknoo\Sellsy\Wordpress\Type;

use Teknoo\Sellsy\Wordpress\Form\Field;
    ...
    public function __construct()
    {
        $this->fieldsName = array(
            ...
            'thirdWeb' => array(
                ...
                'code' => 'thirdWeb',
                'description' => __('Website', 'wpsellsy'),
                'defaultValue' => '',
                'prefsList' => null,
            ),
            'contactCivil' => array(
            ...
            'addressName' => array(
                ...
                'code' => 'addressName',
                'description' => __('Address 1', 'wpsellsy'),
                'defaultValue' => '',
                'prefsList' => null,
            ),
            'addressPart1' => array(
                'type' => 'text',
                'name' => __('Address 2', 'wpsellsy'),
                'code' => 'addressPart1',
                'description' => __('Address 2', 'wpsellsy'),
                'defaultValue' => '',
                'prefsList' => null,
            ),
            'addressPart2' => array(
                'type' => 'text',
                'name' => __('Address 3', 'wpsellsy'),
                'code' => 'addressPart2',
                'description' => __('Address 3', 'wpsellsy'),
                'defaultValue' => '',
                'prefsList' => null,
            ),
            'addressZip' => array(
